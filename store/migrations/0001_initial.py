# Generated by Django 4.1.2 on 2022-10-30 12:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('gender', models.CharField(blank=True, choices=[('M', "Men's dresses"), ('W', "Women's dresses"), ('B', "Baby's dresses")], default='d', help_text='Категория по полу', max_length=1)),
                ('slug', models.SlugField(max_length=200, unique=True, verbose_name='SLUG')),
                ('name', models.CharField(blank=True, db_index=True, max_length=200, null=True, verbose_name='Категория по полу')),
            ],
            options={
                'verbose_name': 'Категория',
